...
# Original file by dgraziotin
# https://github.com/dgraziotin/osx-docker-mysql/blob/master/create_mysql_users.sh
...
mysql --user=stock --password=stock stock_exchange < init.sql
